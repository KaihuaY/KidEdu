...
// legacy emoji sticker book (src/content/stickers.ts), collapsed, for saves
// that still have some from before this reward system existed.
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      {stickers.length > 0 && (
        <div className="cc-card" style={{ padding: '0.75rem' }}>
          ...
          >
            {stickersOpen ? '▾' : '▸'} Old stickers ({stickers.length})
          </button>
          {stickersOpen && (

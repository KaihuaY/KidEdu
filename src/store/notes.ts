...
// leaves for the kid, shown on Home until she taps "Got it". Mirrors the
// thin-wrapper-over-update() shape of src/store/piano.ts.
...
/** Marks a note as seen (Nora tapped "Got it"). Safe to call for an id that no longer exists. */
